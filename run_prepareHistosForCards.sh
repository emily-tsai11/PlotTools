...
OUTPUT_DIR=datacard_preparation_07042026_correctTTweights_newTTBB/
YEAR=2024
...
python3 prepareHistosForCards_fast.py --input_dirs $INPUT_DIR/mc/ --output_dir $OUTPUT_DIR --tree_name Events --year $YEAR --nproc 16 --extra_syst_dir $SYST_DIR --flavtag_sf_json $FLAVTAG_SF_JSON
